...
for index_file = 1 : 12
  ...
  q_matrix_real = double( readNPY( [ 'q_matrix_real_one_cnot' num2str( index_file + 100 ) '.npy' ] ) );
  q_matrix_imag = double( readNPY( [ 'q_matrix_imag_one_cnot' num2str( index_file + 100 ) '.npy' ] ) );
  ...
  for index_image = 1 : n_train
    ...
    for index_j = 1 : 14
      ...
      for index_k = 1 : 14
        ...
        current_output( index_j, index_k, : ) = circuit_one_cnot_all( temp( : ) );
  ...
  eval( [ 'save result_mnist_all_one_cnot' num2str( index_file + 100 ) '.mat net info' ] )
